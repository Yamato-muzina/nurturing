...
namespace nurturing
{
    public partial class Chimera : Form
    {
        string filePath = @"C:\Users\yamat\source\repos\nurturing\csv\chimera.csv";
        ...
        private void Chimera_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            rearing rearingForm = new rearing(1);
            File.WriteAllText("selectnum.txt", "1");
            rearingForm.Show();
            this.Hide();
        }
    }
